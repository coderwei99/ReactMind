...
export default function MainMap({ defaultNode, nodeContainerRef }: IProps) {
  ...
  return (
    <div id={XMIND_WRAPPER_CLASS_NAME} ref={canvasContainerRef} className='relative'>
      {/* 绘制所有的节点 */}
      <RootNode nodeContainerRef={nodeContainerRef} reRenderLine={reRenderLine} defaultNode={defaultNode} allNodeRefs={allNodeRefs} />
